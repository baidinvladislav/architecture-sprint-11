...
2. **Клиентский интерфейс операторов на PowerBuilder** — устаревший интерфейс.
   - Подключался напрямую к DWH.
   - Содержал логику отображения и бизнес-логику.

3. **BI-система (Power BI)** — подключен прямо к DWH.
...
![state_before.png](state_before.png)
